...
namespace WeChatWASM
{
    ...
    public class WXEditorWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            //if (webgl2)
            //{
            //    bool gamma0 = PlayerSettings.colorSpace == ColorSpace.Gamma;
            //    bool linear0 = PlayerSettings.colorSpace == ColorSpace.Linear;
            //    bool gamma = GUILayout.Toggle(gamma0, "Gamma                  ", toggleStyle);
            //    bool linear = GUILayout.Toggle(linear0, "Linear              ", toggleStyle);
            //    if(gamma0 != gamma && gamma)
            //    {
            //        UpdateColorSpace(ColorSpace.Gamma);
            //    }
            //    if(linear0 != linear && linear)
            //    {
            //        UpdateColorSpace(ColorSpace.Linear);
            //    }
            //}
        ...
        private void SettingWXTextureMinJSLib()
        {
            ...
            string jsLibRootDir = $"Assets{DS}WX-WASM-SDK{DS}Plugins{DS}";
            //下方顺序不可变动
